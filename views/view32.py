    ...
    def render_style(target_df, pivot_cols):
        ...
        styled2 = style_cmap(
            ...
            gradient_rules=[
                ...
                {"col": ("전체 세션수", "CPA"), "cmap":"OrRd_r", "low":0.3, "high":-0.45},
                {"col": ("PDP조회", "CPA"), "cmap":"OrRd_r",  "low":0.3, "high":-0.45},
                {"col": ("PDPscr50", "CPA"), "cmap":"OrRd_r", "low":0.3, "high":-0.45},
                {"col": ("가격표시", "CPA"), "cmap":"OrRd_r", "low":0.3, "high":-0.45},
                {"col": ("쇼룸찾기", "CPA"), "cmap":"OrRd_r",  "low":0.3, "high":-0.55},
                {"col": ("장바구니", "CPA"), "cmap":"OrRd_r",  "low":0.3, "high":-0.55},
                {"col": ("쇼룸10초", "CPA"), "cmap":"OrRd_r", "low":0.3, "high":-0.65},
                {"col": ("쇼룸예약", "CPA"), "cmap":"OrRd_r", "low":0.3, "high":-0.65},
                {"col": ("구매완료", "CPA"), "cmap":"OrRd_r", "low":0.3, "high":-0.75},
            ],
        )
