...
def main():
    ...
    # 탭 추가 ( 하드코딩 )
    kpi_tabs = st.tabs(["전체", "일반", "자사", "니즈", "연관", "경쟁"])
    _patterns = {"일반": "일반",
                 "자사": "자사명",
                 "니즈": "니즈",
                 "연관": "연관",
    ...
    for t, label in zip(kpi_tabs, ["전체", "일반", "자사", "니즈", "연관", "경쟁"]):
        with t:
    ...
    # 1) 탭을 최상단에 먼저 렌더 ( 하드코딩 )
    tabs = st.tabs(["전체", "일반", "자사", "니즈_사이즈", "니즈_매트리스유형", "니즈_프레임기능", "니즈_타겟상황", "연관_가구", "경쟁"])
    patterns = {"일반": "일반",
                 "자사": "자사명",
                 "니즈_사이즈": "니즈_사이즈",
                 "니즈_매트리스유형": "니즈_매트리스유형",
    ...
    # ( 하드코딩 )
    for tab, label in zip(tabs, ["전체", "일반", "자사", "니즈_사이즈", "니즈_매트리스유형", "니즈_프레임기능", "니즈_타겟상황", "연관_가구", "경쟁"]):
        with tab:
            pat = patterns[label]
